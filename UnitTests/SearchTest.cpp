...
#include "../OmegaChessEngine/AlphaBeta.cpp"
#include <thread>
...
namespace UnitTests
{
	...
	public:
		...
		TEST_METHOD(SearchSpecialPositions)
		{
			...
			//TO DO : the two kings could go one next to the other
			...
			BoardRepresentation boardRepresentation12{ "5Rr1/1pp3PR/p7/1k1p1P2/5N2/1N1P4/PPP4P/5K2 b - - 2 36" };
			m = search.run(boardRepresentation12).getCoordinateAlgebraicNotation();
